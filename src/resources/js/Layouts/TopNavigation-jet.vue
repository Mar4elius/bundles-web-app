<template>
<nav class="bg-white border-b border-gray-100 bg-gray-600">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <jet-nav-link v-for="link in topNavigationLinks" :href="route(link.route)" :active="route().current(link.route)">
                        {{ link.name }}
                    </jet-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <jet-responsive-nav-link v-for="link in topNavigationLinks" :href="route(link.route)" :active="route().current(link.route)">
                {{ link.name }}
