	...
	<app-layout>
		<template v-slot:main>
			...
			<div class="bg-white rounded-md relative">
				<whole-div-loading-animation v-if="isLoading" />
...
<script>
	...
	import WholeDivLoadingAnimation from '@/Components/Support/WholeDivLoadingAnimation';
